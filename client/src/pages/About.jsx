...
export default function About() {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-neelstate-800">
        About Neelstate
      </h1>
      <p className="mb-4 text-neelstate-700">
        Neelstate is a leading real estate agency that specializes in helping
